                              ...
                              new Container(
                                ...
                                child: new Container(
                                  ...
                                  child: new FlatButton(
                                    ...
                                    highlightColor: Color.fromRGBO(242, 244, 248, 1),
                                    child: new Container(
                                      alignment: Alignment.centerLeft,
                                  child: new Text(
                                  'about omni wallet'.toUpperCase(),
                                  style: nowShow == 'wallet'?UtilStyle.tagTitleFontActive:UtilStyle.tagTitleFont,
                                ),
                                    ),
                                  ),
                                ),
                                ...
                                child: new Container(
                                  ...
                                  child: new FlatButton(
                                    onPressed: (){
                                      ...
                                      omniContentHeight = ScreenUtil().setHeight(500);
                                      nowShow = 'omni';
                                      setState(() {
                                  ...
                                  child: new Text(
                                  'ABOUT OMNI',
                                  style: nowShow == 'omni'?UtilStyle.tagTitleFontActive:UtilStyle.tagTitleFont,
                                ),
                                    ),
                                  ),
                                ),
                                ...
                                child: new Container(
                                  ...
                                  child: new FlatButton(
                                    onPressed: (){
                                      ...
                                      contactContentHeight = ScreenUtil().setHeight(500);
                                      omniHeight = ScreenUtil().setHeight(640);
                                      omniContentHeight = ScreenUtil().setHeight(500);
                                      nowShow = 'contact';
                                      setState(() {
                                  ...
                                  style: nowShow == 'contact'?UtilStyle.tagTitleFontActive:UtilStyle.tagTitleFont,
                                ),
                                    ),
                                  ),
                                ),
                ...
                new Container(
                  ...
                  child: RichText(
                    text: TextSpan(
                      children: [
                        TextSpan(
                          text: "Something not working in the wallet properly? Check our 'Open Issues', If you don't see your specific topic open a new issue to let us know. (Please include as many details as possible including ",
                          style: UtilStyle.aboutContent
                        ),
                        TextSpan(
                ...
                new Container(
                  child: RichText(
                    text: TextSpan(
                      children: [
                        TextSpan(
                          text: "Not sure how to do something or just need some assistance? Our support team can be reached directly at ",
                          style: UtilStyle.aboutContent
                        ),
                        TextSpan(
