...
class ImportAddress extends StatefulWidget {
  _ImportAddressState createState() => new _ImportAddressState();
}

class _ImportAddressState extends State<ImportAddress> {
  bool isAccept = false;
          ...
          body: Container(
            ...
            child: new Stack(
              children: <Widget>[
                ...
                new Positioned(
                  bottom: ScreenUtil().setHeight(132),
                  child: new Container(
                    width: ScreenUtil().setWidth(376),
                    child: new Row(
