...
class _FaqState extends State<Faq> {
  List<Map<String, Object>> faqData = [
    ...
    },
    {
      ...
      'content':
          'An address (in your wallet) which allows you to track your funds and create secure offline transactions. Your offline transaction can then be signed by your offline Armory client providing you the same security of an Armory offline wallet. Take a look at the complete guide on our wiki.'
    },
    {
